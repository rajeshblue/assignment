# Run the analysis -> creates the tiny data set and saves it under "Rajesh_Tidy_Data.txt"
...
# Clears off parentheses  because otherwise they are transformed to dots.
